...
by clicking on``Choosing/Upload Expression Data" tab,
users can upload individual expression data file (i.e. data file from each study) 
or choose the existing saved data file as in Figure~\ref{fig:GUIpreprocessing} {\color{red} (1)}.
