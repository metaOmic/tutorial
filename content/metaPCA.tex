...
The X-axis (horizontal) is the first principal component and 
The Y-axis (vertical) is the second principal component.
Each dot represent a sample in a study with the sample label marked to top right of the figure.
}
